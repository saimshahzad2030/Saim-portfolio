                ...
                <div className={`flex items-center justify-between `}>
                    <div className={`flex items-center justify-between flex-shrink-0 sm:w-full lg:w-full 2xl:w-full  `}>
                        ...
                        <div className={`hidden sm:flex flex-grow flex flex-row items-center justify-end space-x-4 sm:space-x-1 lg:space-x-2 2xl:space-x-1 2xl:ml-4 xl:ml-4 lg:ml-4 md:ml-2 sm:ml-1`}>
                            ...
                            {/* <Link href="/experience" className={`lg:text-lg 2xl:text-2xl xl:text-xl sm:text-md ${selectedLink === 'expertise' ? ' text-gray-100 bg-gray-700' : 'text-gray-700 bg-gray-100  hover:bg-gray-700 hover:text-gray-100'}   rounded-md px-3 2xl:py-4 py-2 2xl:px-8 lg:px-2 sm:px-1 lg:text-lg hover:text-gray-100 hover:bg-gray-700  transition-transform transform hover:scale-105 ${style.link}`}>Experience</Link> */}
                ...
                {isMenuOpen && (
                    <div className={`sm:hidden mt-4 bg-gray-100`}>
                        <div className={`flex flex-col items-center`}>
                            ...
                            {/* <Link href="/experience" className={`${menuLinksVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-8'} text-xl text-gray-700 ${style.link} mt-4 transition-opacity duration-500 ease-in-out transform`}>Experience</Link> */}
